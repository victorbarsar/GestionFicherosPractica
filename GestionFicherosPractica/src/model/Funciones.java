...
public class Funciones {
    ...
    // Método auxiliar para manejar rutas, por defecto se guardan las cosas en la carpeta del proyecto
    ...
    // 1. Crear la carpeta en la ruta que elijas , por defecto es la del proyecto
    ...
    // 2. Crear/actualizar archivo, por defecto se guardan las cosas en la carpeta del proyecto
    ...
    // 3. Listar archivos que hay en la carpeta que decidas, por defecto muestra la carpeta del proyecto
